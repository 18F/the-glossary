...
**<a name="governmentwide-acquisition-contract"></a>[Governmentwide acquisition contract](#governmentwide-acquisition-contract)** (GWAC) \
...
A document that captures and agrees the work activities, deliverables and timeline that a vendor will execute against in performance of work for a customer.
